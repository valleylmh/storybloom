...
- 状态：文字、8 张插图与整本验收已完成；已接入 `src/lib/library/haoqi.ts`，8 页 `imageStatus` 均为 `"complete"`，`comingSoon` 发布态为 `false`；全系列验证已完成
...
- 第 8 页只用高挂的月亮引出“月亮为什么一直跟着我走”，自然衔接第 2 本，不把月亮误写成蓝天成因的一部分。
...
8. 回家路上，月亮高高挂在前方。朵朵走了几步又回头：“月亮为什么一直跟着我走呢？”
   On the way home, the moon hung high ahead. After a few steps, Duoduo looked back. "Why does the moon keep following me?"
   画面：蓝调夜色中母女牵手回家，朵朵回头望向高挂的满月，明确衔接下一本《月亮为什么跟着我走》。
...
- 第 3 页的发光点是气体分子的象征化表现；第 4 页明确显示短蓝波的多方向散射；第 8 页以自然满月提出下一问。
- 第 4 页首版过度继承第 1 页的行走构图，与相邻页面重复；最终版已重做为无人物的纯天空散射示意，保留统一材质与色彩，同时让科学关系更清楚。

## 当前集成与验证状态

- [x] 科学表达、人物连续性与整本画面验收已完成。
