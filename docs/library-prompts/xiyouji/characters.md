...
- 悟空与如意金箍棒的唯一生产母版：
  `content-drafts/xiyouji/_references/sun-wukong-master-reference.png`。
- 母版由第 1 回第 7 页、第 3 回第 6 页、第 6 回第 6 页和第 10 回第 1 页共同校准；
  新图和旧图返工必须把母版作为**第一角色参考图**，不能只依赖文字 prompt。
- 悟空固定为金棕毛、浅棕脸胸、琥珀大眼、短尖发簇、金黄无袖坎肩、朱红腰带、
  深红裤和赤足；第 6 回第 6 页起只增加一条光滑细金头环，不增加长袖、鞋、披风或盔甲。
- 如意金箍棒固定为**朱红色细直棒身 + 两端窄金箍**；不得漂移为木棍、棕色棍、纯金棍、
  粗柱、长枪或带刃武器。画面没有金箍棒时不得因引用母版而额外添加。
- 多人同框尤其容易被唐僧五佛冠、沙僧月牙铲或八戒钉耙污染；生成后必须逐页对照母版，
  接触表只能用于整本初筛，发现头环、衣袖、毛色或棒身不一致时要回到单页检查。

### 2026-08-17 全系列视觉审计

- 第 1–30 回和第 51–58 回整体接近原始锚点。
- 第 31–50 回、第 59–60 回发现集中漂移：悟空变成深毛成年脸、土黄长袖衣、粗花纹头环，
  金箍棒多次变成木色或纯金长棍。
- 本次已完成第 31–41 回全部 88 页的母版定向修正。
  后续旧页返工继续遵循同一母版，不得重新设计人物。

所有西游记书籍的每页插图 prompt **必须逐字包含当页出场角色的完整外观锁定描述**，
不能只写角色名字、`same character` 或 `use established anchors exactly`。若草稿中的简写、颜色或
配件与本卡冲突，以本卡和下方首次出场锚点为准。生成新角色时先完成指定锚点页，再让后续页面只
引用对应锚点；逐页比对脸型、毛色/肤色、眼睛、发型、服色、配件和比例，不得漂移。

## 全系列风格锁定（global style）

premium polished 3D clay-like animated-film children's picture-book illustration,
warm cinematic light, tactile handmade textures, expressive rounded characters,
mythical ancient China setting, square 1:1 composition;
no image text, letters, speech bubbles, logos, watermark, modern objects,
weapons pointed at anyone, injury, blood, fear, or scary imagery.

## 孙悟空连续时间线（不得提前或倒退）

| 回目与页码 | 固定状态 | 视觉锚点 |
| --- | --- | --- |
| 第 1 回第 1 页 | 只有仙石，悟空尚未出场 | 无角色锚点 |
| 第 1 回第 2–6 页 | 裸石猴：无衣饰、无鞋、无头环、无金箍棒 | 第 1 回第 2 页 |
| 第 1 回第 7 页 | 群猴送上金黄坎肩、朱红腰带、深红长裤 | 第 1 回第 7 页 |
| 第 1 回第 8 页至第 3 回第 4 页 | 固定美猴王服装；无头环、无金箍棒 | 第 1 回第 7 页 |
| 第 3 回第 5 页 | 金箍棒首次作为海底红金柱出现，悟空尚未持有 | 悟空仍引用第 1 回第 7 页 |
| 第 3 回第 6 页至第 6 回第 5 页 | 固定服装 + 细长红金金箍棒；无头环 | 第 3 回第 6 页 |
| 第 6 回第 6 页起 | 固定服装 + 金箍棒 + 眉毛上方的细金色头环 | 第 6 回第 6 页 |
| 第 8 回第 3–4 页 | 悟空暂变金棕色小猪崽，细金色头环保留 | 第 8 回第 3 页 |
| 第 8 回第 5 页起 | 恢复带头环的猴形，不保留猪崽特征 | 第 6 回第 6 页 |

### 裸石猴锁（第 1 回第 2–6 页）

a small lively stone monkey with warm golden-brown fur, a bare tan face and chest,
big bright amber eyes, round ears, a short pointed hair tuft, and a long expressive tail;
he wears no clothes, shoes, crown, circlet, headband, armor, cape, or staff; cheerful,
curious, never menacing; child-friendly rounded animated-film proportions.

### 美猴王锁：无金箍棒、无头环（第 1 回第 7 页至第 3 回第 5 页）

Sun Wukong is a small lively monkey with warm golden-brown fur, a bare tan face and
chest, big bright amber eyes, round ears, a short pointed hair tuft, and a long expressive
tail; he wears the same golden-yellow sleeveless tunic, vermilion sash, and dark red
trousers, with no shoes, crown, circlet, headband, armor, cape, or staff; cheerful,
curious, never menacing; child-friendly rounded animated-film proportions.

第 3 回第 5 页允许红金柱形金箍棒作为独立场景物件出现，但悟空身上和手中仍不得出现金箍棒。

### 持金箍棒锁：无头环（第 3 回第 6 页至第 6 回第 5 页）

Sun Wukong is a small lively monkey with warm golden-brown fur, a bare tan face and
chest, big bright amber eyes, round ears, a short pointed hair tuft, and a long expressive
tail; he wears the same golden-yellow sleeveless tunic, vermilion sash, and dark red
trousers, with no shoes, crown, circlet, headband, armor, or cape; he carries the same
slender red-and-gold staff upright like a walking stick or safely shrunk behind one ear,
never swung or pointed at anyone; cheerful, quick-witted, never menacing; child-friendly
rounded animated-film proportions.

### 持金箍棒 + 细金色头环锁（第 6 回第 6 页起）

Sun Wukong is a small lively monkey with warm golden-brown fur, a bare tan face and
chest, big bright amber eyes, round ears, a short pointed hair tuft, and a long expressive
tail; he wears the same golden-yellow sleeveless tunic, vermilion sash, and dark red
trousers, plus one simple narrow smooth golden headband centered above his eyebrows;
the headband is plain polished gold with no jewels, spikes, dangling pieces, helmet, or
crown, and he has no armor, cape, or shoes; he carries the same slender red-and-gold
staff upright like a walking stick or safely shrunk behind one ear, never swung or pointed
at anyone; cheerful, quick-witted, never menacing; child-friendly rounded animated-film
proportions.

- 细金色头环是第 6 回第 6 页唐僧赠送、悟空自愿戴上的守护约定；不表现咒语、收紧、疼痛、控制或惩罚。
- 悟空的细金色头环不得变成唐僧的五佛冠，也不得漂移成深金色粗箍、王冠、头盔或带宝石的额饰。
- 金箍棒固定为 `a slender red-and-gold staff`；只可直立、当手杖、安全固定、作杠杆或缩小藏在耳后。

### 悟空小猪崽变身锁（第 8 回第 3–4 页）

Wukong's piglet form is a tiny round golden-brown piglet with a tan snout, bright amber
eyes, small rounded ears, and the same simple narrow smooth golden headband centered
above his eyebrows; playful, unmistakably friendly, with no clothing or weapon.

## 主要角色完整锁定与视觉锚点

### 菩提祖师

a serene elderly sage with a long flowing white beard and eyebrows, hair in a high
topknot, wearing layered cream-and-sage Taoist robes with wide sleeves and a wooden
staff; kind, wise, gently smiling.

- 首次与固定锚点：第 2 回第 3 页。
- 教学场景可以不手持木杖，但木杖应安全放在身旁；不得变成佛教袈裟、帝王服或武将装束。

### 东海龙王

a stately dragon king with a friendly turquoise-and-gold scaled face, flowing white
whiskers, and sea-green court robes with pearl ornaments; dignified but warm, never
frightening; child-friendly rounded animated-film proportions.

- 首次与固定锚点：第 3 回第 3 页龙宫门前迎接悟空。
- 第 3 回第 4–7 页必须保持青绿金鳞脸、白色长须、海绿色珍珠朝服；不变成全身巨龙或凶恶海怪。

### 玉帝

the Jade Emperor is a serene older celestial ruler with a kind round face, a long neatly
combed black-and-silver beard, layered ivory-and-pale-gold cloud-patterned imperial
robes, and a tall jade ceremonial crown; calm, patient, and never threatening.

- 首次与固定锚点：第 4 回第 1 页天宫庭院。
- 玉冠固定为高而简洁的青玉礼冠；不得变成悟空的细金色头环、武将头盔或西式王冠。

### 唐僧（唐三藏 / Tang Seng）

a gentle young monk with a smooth round face and warm brown eyes, wearing a
russet-and-gold kasaya robe over cream under-robes and a five-buddha crown; calm,
kind, softly smiling; child-friendly rounded animated-film proportions.

- 首次远景：第 5 回第 8 页；第一张清楚正面与固定视觉锚点：第 6 回第 1 页。
- 第 6 回起脸型、暖棕眼睛、赭金袈裟、米白内袍和五佛冠不得变化。
- 五佛冠只属于唐僧；不得把它画成悟空的细金色头环，也不得省略成普通发髻。

### 小白龙 · 龙形

Little White Dragon is a youthful slender Chinese dragon with pearl-white scales, a
pale sky-blue mane and tail tuft, two short smooth golden antler-like horns, a small
sky-blue diamond mark centered on his forehead, large gentle teal eyes, a rounded
snout, and small tucked claws; curious and proud but never frightening, with
child-friendly rounded proportions.

- 首次水下剪影：第 7 回第 1 页；第一张完整龙形与固定锚点：第 7 回第 2 页。
- 龙形身份标记固定为：**额心小蓝菱形 + 青绿色大眼 + 淡天蓝鬃毛**。

### 白龙马 · 马形

White Dragon Horse is the willing horse form of Little White Dragon: a graceful compact
white horse with a luminous pearl-white coat, pale sky-blue mane and tail, the same small
sky-blue diamond mark centered on his forehead, and the same large gentle teal eyes; he
wears a simple russet saddle blanket and a teal-and-gold bridle with no armor, and has
friendly child-safe proportions.

- 变身与固定锚点：第 7 回第 7 页；第 7 回第 8 页起保持同一马形。
- 龙形与马形必须共享**完全相同的蓝菱形位置、形状和青绿眼色**，这是跨形态身份识别核心。
- 不得漂移成银鬃黑眼、纯白无标记马、独角兽或披甲战马。

### 猪八戒

Zhu Bajie is a sturdy round-bodied pig-faced traveler with a soft rose-tan snout, rosy
cheeks, large floppy ears, big warm brown eyes, and short black hair tied in a tiny topknot;
he wears a dark teal cross-collar tunic with a cream inner collar, mustard-yellow sash,
loose charcoal trousers, and black cloth shoes; he carries a rounded wooden-handled
nine-tooth rake like a farm tool, never raised or pointed at anyone; food-loving, playful,
warmhearted, never scary; child-friendly rounded proportions.

- 首次与固定锚点：第 8 回第 1 页；第 2 页可作为脸部、点心篮和服装近景校验。
- 固定配色是深青交领上衣、芥末黄腰带、炭灰裤、黑布鞋；不得漂移成靛蓝裤、酒红腰带或裸上身。
- 九齿钉耙齿端必须圆钝，只作为农具、行走工具或安全搬运工具。

### 沙僧（沙悟净）

Sha Wujing is a tall sturdy but gentle river guardian with warm bronze skin, a round
friendly face, a thick dark-red beard, a shaved head, calm dark eyes, a slate-blue monk
robe, a sand-colored sash, and a necklace of large smooth dark wooden beads; he carries
a broad round-edged crescent spade upright like a ceremonial walking staff, never raised
or pointed at anyone; steady, patient, dependable, never frightening; child-friendly
rounded proportions.

- 首次完整出场与固定锚点：第 9 回第 2 页流沙河浅水边。
- 木珠只用圆滑深色木珠，不使用骷髅、骨头或牙齿；月牙铲必须宽而圆钝，不画锋利刃口。

## 白骨精温和云灵与三种伪装

“白骨精”只保留经典角色名，真实形态固定为温和云灵；全书不出现骨架、骷髅、尸体、尖牙或恐怖阴影。
四种形态共享两项识别线索：**同一枚银色月牙坠 + 同一缕淡紫色丝带云雾**。

### 云灵真身

the White Bone Spirit's true magical form is an elegant floating lavender cloud spirit
with pearl-pale skin, silver-white hair in a high bun, expressive violet eyes, flowing
lavender-and-moon-gray robes, the same small crescent-shaped silver pendant, and
ribbon-like lavender mist; mischievous but never frightening, with open empty hands and
child-friendly rounded proportions; no visible bones or skulls.

- 双形态概念锚点：第 10 回第 2 页；完整真身固定锚点：第 10 回第 7 页。

### 第一种伪装 · 送果子的姑娘

a smiling young mountain fruit seller with a warm oval face, dark hair in a low braided
bun, simple rose-and-cream ancient clothing, and a woven basket of bright peaches; the
same crescent-shaped silver pendant remains visible at her collar and the same faint
lavender ribbon-mist trails behind her; friendly ordinary appearance, never seductive or
threatening.
...
a gentle elderly mountain grandmother with a kind lined round face, silver-gray hair in a
low bun, muted plum-and-gray robes, and a simple walking basket; the same crescent-shaped
silver pendant and the same faint lavender ribbon-mist remain visible; ordinary and
friendly, with the magical clues—not her age—revealing the disguise.

- 固定锚点：第 10 回第 4 页。

### 第三种伪装 · 白胡子老爷爷

a kindly white-bearded mountain grandfather with a warm lined face, short swept-back
silver hair, a soft white beard, and moss-green-and-brown robes; the same crescent-shaped
silver pendant hangs at his collar and the same faint lavender ribbon-mist curls behind
him; ordinary and friendly, with the magical clues—not his age—revealing the disguise.

- 固定锚点：第 10 回第 6 页。

## 配角与仪仗基准

- 群猴：smaller gray-brown monkeys with cream faces, playful and rounded.
- 天兵天将：friendly heavenly attendants in golden ceremonial armor, carrying colorful
  blank banners instead of drawn weapons; expressions may be welcoming, surprised,
  firm, or amused, never angry or threatening. 固定锚点：第 4 回第 1 页。
- 天马：friendly white celestial horses with pale-gold manes, rounded proportions, calm
  eyes, standing or trotting safely on soft clouds. 固定锚点：第 4 回第 1 页。

## 第 3–10 回视觉锚点速查

| 回目 | 新增或变化 | 锚点页 |
| --- | --- | --- |
| 第 3 回《龙宫借宝》 | 东海龙王 | 第 3 页 |
|  | 红金金箍棒首次被悟空持有 | 第 6 页 |
| 第 4 回《大闹天宫》 | 玉帝、天兵仪仗、天马 | 第 1 页 |
| 第 5 回《五行山下》 | 唐僧首次远景 | 第 8 页 |
| 第 6 回《师徒相遇》 | 唐僧清晰正面 | 第 1 页 |
|  | 悟空细金色头环 | 第 6 页 |
| 第 7 回《白龙马》 | 小白龙完整龙形 | 第 2 页 |
|  | 白龙马完整马形 | 第 7 页 |
| 第 8 回《高老庄遇八戒》 | 猪八戒 | 第 1 页 |
|  | 悟空小猪崽变身 | 第 3 页 |
| 第 9 回《流沙河收沙僧》 | 沙僧 | 第 2 页 |
| 第 10 回《三打白骨精》 | 云灵 + 姑娘伪装 | 第 2 页 |
|  | 老奶奶伪装 | 第 4 页 |
|  | 老爷爷伪装 | 第 6 页 |
|  | 云灵完整真身 | 第 7 页 |
...
- 妖怪、神将与云灵形象趣味化，不恐怖，无威胁性表情。
- 不出现死亡、受伤、血、骷髅、骨头、惩罚性疼痛或羞辱描写。
- 悟空的金箍棒、八戒的九齿钉耙、沙僧的月牙铲只可直立、安全固定、当手杖、农具或合作工具。
- 天兵天将只持无字仪仗旗，不拔刀、不举枪、不围攻；第 4 回冲突表现为云海追逐游戏。
- 第 4 回不出现酒或把金丹当糖果吃，避免儿童模仿饮酒、误食药物。
...
- 学艺必须体现长期积累：祖师耐心讲解，悟空反复练习，明确经过许多年才学有所成；
  不得写成一夜听完口诀便立刻掌握全部本领。
- “十万八千里”英文统一写作 **one hundred and eight thousand li**，不换算成不一致的英里数。
